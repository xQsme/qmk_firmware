 ...
 */
    ...
    const uint8_t LED_LIST_NUMROW[] = { LED_GRV, LED_1, LED_2, LED_3, LED_4, LED_5, LED_6, LED_7, LED_8, LED_9, LED_0, LED_MINS, LED_EQL, LED_BSPC, LED_HOME};
	
    const uint8_t LED_LIST_NAV[] = { LED_HOME, LED_PGUP, LED_PGDN, LED_END};
	
    const uint8_t LED_LIST_MODS[] = { LEB_TAB, LED_CAPS, LED_LSFT, LED_LCTL, LED_LWIN, LED_LALT, LED_RALT, LED_FN, LED_RCTL};
